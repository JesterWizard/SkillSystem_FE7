...
Proc* ProcStart(const ProcInstruction*, Proc*); //! FE8U = (0x08004494+1)
Proc* ProcStartBlocking(const ProcInstruction*, Proc*); //! FE8U = (0x080044F8+1)
void EndProc(Proc*); //! FE8U = (0x08004584+1)
void ExecProc(Proc*); //! FE8U = (0x08004690+1)
void BreakProcLoop(Proc*); //! FE8U = (0x080046A0+1)
Proc* ProcFind(const ProcInstruction*); //! FE8U = (0x080046A8+1)
void ProcGoto(Proc*, int); //! FE8U = (0x08004720+1)
void ProcGotoPtr(Proc*, const ProcInstruction*); //! FE8U = (0x08004758+1)
void ProcMark(Proc*, int); //! FE8U = (0x08004760+1)
void ProcSetEndFunc(Proc*, void(*)(Proc*)); //! FE8U = (0x08004768+1)
void ForEveryProc(void(*)(Proc*)); //! FE8U = (0x0800476C+1)
void ForEachProc(const ProcInstruction*, void(*)(Proc*)); //! FE8U = (0x08004794+1)
void ProcHaltEachMarked(int); //! FE8U = (0x080047E8+1)
void ProcResumeEachMarked(int); //! FE8U = (0x0800480c+1)
void EndEachProcMarked(int); //! FE8U = (0x08004834+1)
void EndEachProc(const ProcInstruction*); //! FE8U = (0x0800486c+1)
void BreakEachProcLoop(const ProcInstruction*); //! FE8U = (0x08004888+1)
