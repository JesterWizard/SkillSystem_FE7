...
ldr	r0, =0x0203A3F0 @BattleUnit@gBattleActor @FE8U
ldr	r1, =0x03004690 @CurrentUnit @FE8U
ldr	r1, [r1]
...
clear_double_battleanime:
	...
	ldr r3, =0x080046a8	@Find6C
	mov	r14, r3
	@dcw	0xF800

	ldr r3, =0x08004584	@Delete6C
	mov	r14, r3
	@dcw	0xF800
...
effect:
	...
	add	r1, #1
	strb	r2, [r1, #0]
	ldr	r1, =0x0203A470 @BattleUnit@gBattleTarget @FE8U
	ldr	r2, =0x0203a50c @BattleRound@gRoundArray  @FE8U

	blh 0x0807b900	@SetupMapBattleAnim	@FE8U
	ldr r0, EffectProc
	mov	r1, #3

	blh 0x08004494	@New6C		@FE8U
	pop	{r0}
	bx r0
