...
DuelistsSkill:
ldr     r0,=Attacker    @Move attacker data into r0.
...
DartingSkill:
ldr     r0,=Defender    @Move attacker data into r0.
...
WardingSkill:
ldr     r0,=Defender    @Move defender data into r1.
