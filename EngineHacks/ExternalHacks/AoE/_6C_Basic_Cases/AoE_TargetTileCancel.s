...
.endm
	...
	.set pr6C_New,                        0x08004494 @ arguments: r0 = pointer to ROM 6C code, r1 = parent; returns: r0 = new 6C pointer (0 if no space available)	@{U}
...
ldrb r0, [r3, #0x10]
ldrb r1, [r3, #0x11]
blh 0x8015a90 @SetCursorMapPosition	@{U}
