...
FE7U table bases: menu `0xB896B0`, serif `0xB8B5B0`. Glyphs install in unused `0x81+` slots.  
Class-type icons that used `0x7B-0x7F` on FE8 are not installed (those slots are vanilla FE7 `{|}~`). 
