...
.macro blh to, reg=r3
  ...
  .short 0xf800
.endm
.equ GetCharPtr, 0x08018D0C //FE8 -> 0x8019430
.equ ActionStruct, 0x0203A868 //FE8 -> 0x203A958
.equ Attacker, 0x203A3F0 //FE8 -> 0x203A4EC
.equ Defender, 0x203A470 //FE8 -> 0x203A56C
.equ CurrentUnit, 0x3004690 //FE8 -> 0x3004E50
.thumb
...
ldr	r6, [r5]
ldr	r0, [r5]
ldr	r1, =#0x8019BE0 //FE8 -> #0x801a3cc
mov	lr, r1
.short 0xf800
...
b	Loop
End:
ldr	r0,=#0x203A3D8 //FE8 -> #0x203A4D4
mov	r1,#0
strb	r1,[r0]
pop	{r4-r7}
pop {r3} 
ldr r0, [r4] 
blh 0x8018A70 //FE8 -> 0x8019150 @GetUnitCurrentHP 
ldr r1, =0x803452D //FE8 -> 0x8037751
bx r1 
