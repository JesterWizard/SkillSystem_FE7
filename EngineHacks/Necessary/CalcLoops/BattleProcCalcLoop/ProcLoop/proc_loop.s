...
ldr     r1,=#0x203A470    @load the defender
mov     r8,r0             @Attacker                @ 0802B3F6 1C06     
mov     r9,r1             @Defender                @ 0802B3F8 4688     

ldr     r0,=#0x203A50C
@ ldr     r0,=0x8029290 //FE8 -> 0x802b444    @pointer to the current round
...
ldr     r0,=0x203A3D8 //FE8 -> 0x203A4D4    @Battle Stats Data?                @ 0802B3FA 4C11   
mov     r6, r0
