...
.macro draw_stats_box showBallista=0
  ...
  mov     r1, r4
  blh     BgMap_ApplyTsa
  ldr     r0, =0x8404A60 //FE7? #0x83FCE2C //FE8 -> #0x8205A24     @map of text labels and positions
  ...
  mov     r5, r0
  ldr     r4, =#0x2003CB4 //FE8 is on $87638 FE7 doesn't seem to have this line, but where it would be is $801FE
...
.macro draw_items_text showBallista=0
  ...
  SS_DrawItemName:
  lsl     r0, r4, #0x3
  ldr     r1, =#0x80184DC  //FE8 -> #0x2003C8C
  add     r0, r0, r1
...
.macro setup_menu
  ldr     r0, =0x2023460 //FE8 -> 0x020234A8
  mov     r1, #0
  blh     FillBgMap
  mov     r0, #0x0
  mvn     r0, r0        @-1
