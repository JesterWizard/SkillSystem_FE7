...
.equ ReturnPoint, 0x8080391 //FE8 -> 0x80877B9
...
ldr r0,=#0x200310C //FE8 -> #0x2003BFC
ldr r0,[r0,#0xC]
add r0,#0x28
add r0,r0,r1
ldrb r5,[r0]
...
add r0,r4,r6
lsl r0,r0,#1
ldr r2,=#0x200323C //FE8 -> #0x2003D2C
mov r8,r2
add r0,r8
mov r3,#4 @sheet ID
...
.equ ReturnPoint2, 0x801E291 //FE8 -> 0x801EA19
...
.equ ReturnPoint3, 0x808B19D //FE8 -> 0x8092795
...
.equ ReturnPoint4, 0x808ABFD //FE8 -> 0x8092205
...
.equ ReturnPoint5, 0x8088D29 //FE8 -> 0x80902BB (not 100% sure about FE7 address)
...
.equ ReturnPoint6, 0x803195D //FE8 -> 0x8034B01
...
.equ ReturnPoint7, 0x809C76F //FE8 -> 0x80A1DA7
...
.equ ReturnPoint8, 0x80802E9 //FE8 -> 0x8087711
