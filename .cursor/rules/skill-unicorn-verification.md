---
description: Skill ASM that computes or branches is not working until Unicorn executed both sides of every branch
globs: EngineHacks/SkillSystem/**/*.s,EngineHacks/SkillSystem/**/*.c,tests/**/*.py
alwaysApply: false
---
