...
class SkillDefinitionToggleTests(unittest.TestCase):
    def test_toggle_macros_preserve_resolved_skill_ids(self):
        ...
        self.assertEqual(resolved["AetherID"], 1)
        self.assertEqual(resolved["BarricadeID"], 2)
        self.assertEqual(resolved["BarricadePlusID"], 3)
        self.assertEqual(resolved["BlackMagicID"], 4)
